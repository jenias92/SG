	...
	public void init() {
		...
		view.getAmutaRadioButton().addActionListener(e->{
			 if(e.getSource() == view.getAmutaRadioButton()){
	        	   view.getComboBox().setVisible(false); // set the textfields that you want to be hidden once the Rectangle button is chosen.
		...
		view.getMitnadevRadioButton().addActionListener(e->{
			 if(e.getSource() == view.getMitnadevRadioButton()){
	        	   view.getComboBox().setVisible(true); // set the textfields that you want to be hidden once the Rectangle button is chosen.
